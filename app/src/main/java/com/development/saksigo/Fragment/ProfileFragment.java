...
import com.development.saksigo.ProfileFeature.CompleteRegistration0Fragment;
import com.development.saksigo.ProfileFeature.CompleteRegistration25Fragment;
import com.development.saksigo.ProfileFeature.CompleteRegistration50Fragment;
import com.development.saksigo.ProfileFeature.CompleteRegistration75Fragment;
...
public class ProfileFragment extends Fragment {
    ...
    int checkProfile=0;
    Boolean booleanCheckProfile = true, booleanCheckProfileAccording = true, booleanCheckNationalId = true, booleanCheckBankAccount = true;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        databaseReference0_25 = FirebaseDatabase.getInstance("https://saksigo-30792-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("KeyPartner");
        databaseReference50 = FirebaseDatabase.getInstance("https://saksigo-30792-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("NationalId");
        databaseReference75 = FirebaseDatabase.getInstance("https://saksigo-30792-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("BankAccount");
        ...
        databaseReference0_25.child(mAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0){
                    ...
                    //if berhasil
                    if(dataSnapshot.hasChild("email") && dataSnapshot.hasChild("fullname") && dataSnapshot.hasChild("image")
                            && dataSnapshot.hasChild("dateOfBirth") && dataSnapshot.hasChild("phoneNumber")
                            && dataSnapshot.hasChild("province") && booleanCheckProfile) {
                        ...
                        booleanCheckProfile = false;


                    }

                    if(dataSnapshot.hasChild("aboutYou") && dataSnapshot.hasChild("legalServicesType") && booleanCheckProfileAccording){
                        ...
                        booleanCheckProfileAccording = false;
                    }
                }
            }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0){
                    ...
                    if(dataSnapshot.hasChild("id") && dataSnapshot.hasChild("firstname") && dataSnapshot.hasChild("lastname")
                            ...
                            && dataSnapshot.hasChild("photoId") && dataSnapshot.hasChild("selfieWithId") && booleanCheckNationalId){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
                    ...
                    if(dataSnapshot.hasChild("accountNumber") && dataSnapshot.hasChild("accountBookPhoto")
                            && dataSnapshot.hasChild("bankName") && booleanCheckBankAccount){
